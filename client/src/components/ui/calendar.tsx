...
type CalendarRootProps = ExtractProps<NonNullable<DayPickerComponents["Root"]>>;

type CalendarChevronProps = ExtractProps<
  NonNullable<DayPickerComponents["Chevron"]>
>;

type CalendarWeekNumberProps = ExtractProps<
  NonNullable<DayPickerComponents["WeekNumber"]>
>;

type CalendarDayButtonProps = ExtractProps<
  NonNullable<DayPickerComponents["DayButton"]>
>;
